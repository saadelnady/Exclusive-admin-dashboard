...
const MyOrders = () => {
  return (
    <div className="col-10 col-md-8 shadow p-3 p-md-5 rounded over-flow-auto d-flex flex-column justify-content-between over-flow-scroll">
      <table className="w-100 rounded">
        <thead>
          <tr className="">
            <th className="py-3">Order ID</th> <th>Status</th>
            <th>Item Qty</th>
            <th>Total</th>
          </tr>
        </thead>
